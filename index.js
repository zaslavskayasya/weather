...
function renderForecast(data){
    ...
    var weather =
       '<div class="row"> ' +
            '<p class="h4 inline col-md-4">Завтра: </p>'+
            '<p class="weatherNow col-md-4 h5 "> '+ weatherForecast.date +' </p>' +
       '</div> '+
       '<div class="row"> ' +
            '<p class="h4 col-md-4">Температура С: </p>'+
            '<p class="weatherNow col-md-4 h5"> '+ data.day.maxtemp_c +' </p>' +
       '</div> '+
       '<div class="row"> ' +
            '<p class="h4 col-md-4">Скорость ветра : </p>'+
            '<p class="weatherNow col-md-4 h5"> '+ data.day.maxwind_kph +' </p>' +
